...
eigenstates for a simple quantum well
"""
...
class QuantumWell(object):
    ...
    def __init__(self, well_length=100, well_height=1.0, N=2048, 
            dt=1e-19, surround=1):
        """
        """
    ...
    def set_device(self, well_length=100, well_height=1.0, N=2048, 
            dt=1e-19, surround=1):
        """
        """
